...
const HeaderContent = () => {
  return (
    <div className="flex flex-wrap justify-evenly gap-10 items-center bg-clip-text text-transparent bg-gradient-to-r from-orange-1 to-orange-700 text-xl text font-bold">
